	               ...
	               <c:forEach items="${page.list}" var="admin" varStatus="status">
		                <tr>
		                  ...
		                  <td>
						      ...
						      <!-- 因为此按钮是迭代出来的，如果有id的话会重复，所以自定义一个属性让它等于此行的id值 -->
        ...
        <script type="text/javascript">
         ...
         // =========================批量删除数据===========================
            $("#selectAll").click(function(){
            	// 使用标签选择器的子选择器的属性选择器，把type='checkbox'的标签的checked属性设置为selectAll的checked状态
            ...
            $("#deleteBatchBtn").click(function(){
            	...
            	console.log(checkedList);// 打印在控制台
            	...
            	layer.confirm('是否删除？', {time:2000}, function(index){
          ...
          // =========================删除单个数据===========================
            $(".deleteBtnClass").click(function(){
            	...
            	layer.confirm('是否删除这条数据？', {btn:['确定', '取消']}, function(index){
